...
class Vulnerabilites extends Model 
{
    ...
    protected $fillable = array('nom_vulnerabilite', 'description_vulnerabilite', 'methodetoutils_vulnerabilite', 'impact_vulnerabilite', 'solution_vulnerabilite', 'probabilite_risk', 'impact_risk');
